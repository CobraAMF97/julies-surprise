    ...
    function moveSnake() {
        ...
        if (newHead.x === food.x && newHead.y === food.y) {
            ...
            if (score >= maxScore) {
                ...
                alert("Félicitations, Julie ! Le serpent sait maintenant que tu es digne de connaître le mot de passe. Le voici : NARVAL. Utilise-le pour découvrir le trésor caché.");
